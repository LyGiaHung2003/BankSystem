...
{
    public partial class Withdraw : Form, IView
    {
        ...
        public Withdraw(int employeeId)
        {
            InitializeComponent();
        ...
        private void buttonSend_Click(object sender, EventArgs e)
        {
            ...
            string resultMessage = trancs.Withdraw(idaccountfr, branchId, amount, pin, CurrentEmployeeId, cont);
